            ...
            >
                <DialogTitle>
                    <Box component={"div"} style={{display:"flex" , justifyContent : "space-between" , alignItems:"center"}}>
                        <Box component={"span"} className="modal-title" style={{width : "300px"}}>Add Token</Box>
                ...
                <DialogContent>
                    ...
                    <Box component={"div"} className="modal-footer" style={{display:"flex" , justifyContent:"space-between"}}>
                        ...
                        <Box component={"button"} className='btn btn-primary btn-md' onClick={() => onAddToken() }>Add</Box>
                    </Box>
                </DialogContent>
            </Dialog>
        </div>
